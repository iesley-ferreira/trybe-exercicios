...
const findPersonByName = (name) => {
  ...
  try {
    ...
    const nomeEEndereço = `Destinatário: ${cliente.name}. Endereço: ${cliente.address.street}, ${cliente.address.number}, ${cliente.address.neighborhood}, ${cliente.address.city} - ${cliente.address.state}. CEP: ${cliente.address.cep} `;
    return nomeEEndereço;
  } catch (error) {
