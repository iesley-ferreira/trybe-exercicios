...
// captura o botão, adiciona um evento de click nele, chama a função showPromo.
...
// insere as mensagens de boas-vindas e da promo na página.
...
// VERIFICA SE O NOME É VÁLIDO (é composto por caracteres de a-z)
...
// VERIFICA SE OS VALORES INSERIDOS NO INPUT É DO TIPO NUMBER
...
/**
 * RECEBE UM NUMERO, E RETORNA O CODIGO PROMOCIONAL DE ACORDO COM O NUMERO DIGITADO
 * @param number - o número da promoção que deseja consultar
 * @returns o valor da matriz promocional no índice do número - 1.
 */
...
// FUNÇÂO QUE VALIDA SE O NUMERO DIGITADO ESTÀ ENTRE 1 e 10 
